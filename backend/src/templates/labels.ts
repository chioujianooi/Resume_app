export const LABELS = {
  classic: {
    en: { summary: 'Summary', experience: 'Experience', education: 'Education', skills: 'Skills', projects: 'Projects', technologies: 'Technologies:' },
  ...
  minimal: {
    ...
    de: { about: 'Über mich', experience: 'Berufserfahrung', education: 'Ausbildung', skills: 'Kenntnisse', projects: 'Projekte' },
  },
} as const;
